...
data-file-validator description
...
## Development environment and release process
 ...
 - create virtualenv with Flask and data-file-validator installed into it (latter is installed in
...
install it (`pip install data_file_validator.tar.gz`), ensure that configuration file exists and
`DATA_FILE_VALIDATOR_SETTINGS` environment variable points to it, ensure that user has access to the
